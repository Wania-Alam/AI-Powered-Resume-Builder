        ...
        <div className='grid lg:grid-cols-2 gap-16 items-center'>
          ...
          <div>
            ...
            <h1 className='text-5xl lg:text-7xl font-extrabold leading-tight'>
              Build Professional Careers With
               AI Power
            </h1>

            <p className='text-gray-300 text-lg leading-9 mt-8'>
              CV Forge is an AI-powered career platform designed to help
              students, fresh graduates, professionals, and job seekers
              create impactful resumes and professional documents effortlessly.
              Our goal is to simplify the job preparation journey through
              modern technology, intelligent automation, and elegant design.
            </p>

            <p className='text-white text-lg leading-9 mt-6'>
              Whether you are applying for internships, entry-level jobs,
              scholarships, or senior corporate positions, CV Forge gives
              you the tools to create ATS-friendly resumes, professional
              letters, and personalized career guidance — all in one place.
            </p>
        ...
        <div className='bg-slate-900 border border-slate-800 rounded-3xl p-10 lg:p-16'>
          ...
          <div className='text-center mb-16'>
            ...
            <p className='text-gray-400 mt-6 max-w-4xl mx-auto text-lg leading-8'>
              We believe career preparation should be accessible,
              intelligent, and stress-free. CV Forge was created to
              empower individuals with modern AI tools that improve
              confidence, professionalism, and productivity during
          ...
          <div className='grid md:grid-cols-3 gap-10'>
            ...
            <div className='bg-slate-800 p-8 rounded-3xl'>
              ...
              <p className='text-gray-400 leading-8'>
                We combine AI technology with practical career-building
                tools to create smarter and faster workflows for users.
              </p>
            </div>
            ...
            <div className='bg-slate-800 p-8 rounded-3xl'>
              ...
              <p className='text-gray-400 leading-8'>
                User data and professional information are protected with
                secure authentication and private storage systems.
              </p>
            </div>
      ...
      <section className='max-w-7xl mx-auto px-6 lg:px-12 py-20'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-gray-400 mt-6 text-lg max-w-3xl mx-auto'>
            Everything you need for professional career preparation
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
          ...
          <div className='bg-slate-900 border border-slate-800 p-8 rounded-3xl'>
            ...
            <p className='text-gray-400 leading-8'>
              Generate summaries, get interview advice, and receive
              intelligent career suggestions instantly.
            </p>
          </div>
          ...
          <div className='bg-slate-900 border border-slate-800 p-8 rounded-3xl'>
            ...
            <p className='text-gray-400 leading-8'>
              Ask questions related to jobs, resumes, internships,
      ...
      <section className='max-w-6xl mx-auto px-6 pb-24'>
        ...
        <div className='bg-slate-900 rounded-3xl p-12 text-center shadow-2xl'>
          ...
          <p className='text-lg text-cyan-100 mt-6 leading-8 max-w-3xl mx-auto'>
            Create professional resumes, generate career documents,
            and receive AI-powered career guidance with CV Forge.
            Your next opportunity starts here.
          </p>

          <button
            className='mt-10 bg-white text-blue-700 px-10 py-4 rounded-2xl font-bold text-lg hover:bg-gray-100 transition'
          >
            Get Started
          </button>
