...
function Contact() {
  useEffect(() => {
    document.title = "CV Forge | Contact";
  }, []);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-5 bg-slate-900 border border-slate-800 p-6 rounded-3xl">
                ...
                <div>
                  ...
                  <p className="text-gray-400 mt-2">yourgmail@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-5 bg-slate-900 border border-slate-800 p-6 rounded-3xl">
                ...
                <div>
                  ...
                  <p className="text-gray-400 mt-2">+92 300 1234567</p>
                </div>
              </div>
          ...
          <div className="bg-slate-900 border border-slate-800 p-10 rounded-3xl shadow-2xl">
            <h2 className="text-4xl font-bold mb-10">Send Message</h2>
