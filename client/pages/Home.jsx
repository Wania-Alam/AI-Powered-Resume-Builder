...
import { FaRobot, FaFileDownload, FaMagic, FaUserTie } from "react-icons/fa";

function Home() {
  useEffect(() => {
    document.title = "CV Forge | Home";
  }, []);
  const fadeUp = {
    ...
    <div className="bg-gray-50 overflow-hidden">
      ...
      <section className="min-h-screen bg-gradient-to-r from-blue-700 to-cyan-500 text-white flex items-center justify-center px-6">
        ...
        >
          ...
          <p className="mt-6 text-xl text-gray-100">
            Create a professional, HR-approved resume with our AI-powered
            builder. Pick a template, fill in the blanks, and download your
            future.
          </p>
        ...
        >
          <div>
            ...
            <h3 className="text-3xl  text-gray-800">
              Why 500,000+ job seekers skipped the word document and used us
              instead.
            </h3>

            <p className="mt-6 text-gray-600 leading-8 text-lg">
              Our AI Resume Builder helps students and professionals generate
              beautiful, ATS-friendly resumes with the power of artificial
              intelligence. Save time, improve your resume quality, and stand
          ...
          >
            <h3 className="text-3xl font-bold">Smart Resume Generation</h3>

            <p className="mt-5 text-lg leading-7">
              AI-powered summaries, skills suggestions, professional templates,
              and instant PDF exports.
            </p>
          </motion.div>
        </motion.div>
      </section>
      ...
      <section className="py-24 bg-white px-6">
        <motion.div
          ...
          className="text-center"
        >
          <h2 className="text-5xl font-bold text-gray-800">What Users Say</h2>
        </motion.div>
        ...
        <div className="max-w-6xl mx-auto mt-16 grid md:grid-cols-3 gap-8">
          {[
            ...
            >
              <p className="text-gray-700 text-lg leading-7">“{review}”</p>

              <h4 className="mt-6 font-bold text-blue-600">User {index + 1}</h4>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-12 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10">
          <div>
            <h2 className="font-logo text-3xl font-bold">CV Forge</h2>
          ...
          <div>
            ...
            <p className="mt-4 text-gray-400">cvforgef@gmail.com</p>
